...
class Utils{
    ...
    static function Qiniu_Client_ret($resp) // => ($data, $error)
    {
        ...
        return array($data, Utils::QiniuResponseError($resp));
    }

    static function Qiniu_Client_Call($self, $url) // => ($data, $error)
    {
        $u = array('path' => $url);
        $req = new QiniuRequest($u, null);
    ...
    static function Qiniu_Client_CallNoRet($self, $url) // => $error
    {
        ...
        return Utils::QiniuResponseError($resp);
    }
...
// class Qiniu_Header
    ...
    static function QiniuResponseError($resp) // => $error
    {
        $header = $resp->Header;
...
// class Qiniu_Client
    ...
    static function Qiniu_Client_do($req) // => ($resp, $error)
    {
        ...
        list($reqid, $xLog) = Utils::getReqInfo($respHeader);
    ...
    static function Qiniu_RequireMac($mac) // => $mac
    {
        ...
        return new QiniuMac($QINIU_ACCESS_KEY, $QINIU_SECRET_KEY);
    }
